...
csv_export_column_headers = {
    'books': ['title', 'authors', 'isbn_13', 'isbn_10', 'publisher', 'publication_year', 'page_count', 'height', 'width', 'thickness', 'retail_price', 'genre', 'inventory_count', 'shelf_space_inches', 'last_month_sales', 'days_of_supply', 'best_buyback_price', 'num_related_books', 'remote_inventory_count', 'remote_retail_price']
}
