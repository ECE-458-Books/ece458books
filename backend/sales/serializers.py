...
class SalesReconciliationSerializer(TransactionGroupBaseSerializer):
    ...
    def create(self, validated_data):
        ...
        for sale_data in sales_data:  #check if sale can be made
            print(sale_data)
            sales_quantities[sale_data['book'].id] = sales_quantities.get(sale_data['book'].id,
                                                                          0) + sale_data['quantity']
    ...
    #             else:
    #                 books_stock_change[sale_data['book'].id] = books_stock_change.get(sale_data['book'].id,
    #                                                                                   0) - sale_data['quantity']
    ...
    #         books_stock_change[book_gaining_stock.id] = books_stock_change.get(book_gaining_stock.id,
    #                                                                            0) + book_quantity_gain
    ...
    def update_transaction(self, instance, transaction_data, transaction_id) -> None:
        self.update_sale(instance, transaction_data, transaction_id)
